...
“词汇测试”按每一组词汇提供听音写日语、中文写日语、日语写中文三种回忆方式。每种方式独立按照 10 分钟、1 天、3 天、7 天、14 天、30 天的间隔复习；三路全部通过后词条才会毕业，并退出普通学习队列。
...
三个学习模块使用缓存优先的页面切换：点击“核心表达”“单词闪卡”或“词汇测试”时立即从本地缓存打开，并在后台静默更新内容。
